...
from taming.modules.diffusionmodules.model import Decoder_withMid, Encoder, Decoder
from taming.modules.vqvae.quantize import VectorQuantizer2 as VectorQuantizer
from taming.modules.vqvae.quantize import GumbelQuantize
from taming.modules.vqvae.quantize import EMAVectorQuantizer

class VQDiffModel2(pl.LightningModule):
    def __init__(self,
                 encconfig,
                 decconfig,
                 branch_encconfig,
        ...
        self.encoder = Encoder(**encconfig)
        self.decoder = Decoder_withMid(**decconfig)
        self.branch_encoder = Encoder(**branch_encconfig, ret_mid_output=True)
